...
tools.deployDbConfig = (databases, cb)=>{
//  console.log('tools.deployDbConfig(), databases:', databases);
...
//  console.log('tools.deployDbConfig, root:', env.root);
//  console.log('tools.deployDbConfig, lines:', lines);

    const cmd = 'echo \'' + lines2 + '\' >' + env.root + '/config/databases.js';
//  console.log('tools.deployDbConfig, cmd:', cmd);
