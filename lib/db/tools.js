...
tools.setupDbs = (databases, cb)=>{
//  console.log('tools.setupDbs(), databases:', databases);
...
//  console.log('tools.setupDbs, root:', env.root);
//  console.log('tools.setupDbs, lines:', lines);

    const cmd = 'echo \'' + lines2 + '\' >' + env.root + '/config/databases.js';
//  console.log('tools.setupDbs, cmd:', cmd);
    exec(cmd, function (error, stdout, stderr) {
//      console.log('tools.setupDbs, exec.error:' + error);
//      console.log('tools.setupDbs, exec.stdout:' + stdout);
//      console.log('tools.setupDbs, exec.stderr:' + stderr);
        cb(error);
    });
}
...
//  console.log('lib.db.tools.create(), dbName:' + dbName + ', props:', props);
    assert(props);
