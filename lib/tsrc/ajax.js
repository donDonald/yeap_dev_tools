...
//          assert.equal(cookies.expires: 2023-12-07T11:20:18.000Z,
    ...
    describe('ajax.text', ()=>{
        describe('ajax.text.get', ()=>{
            it('Make get to missing host(ENOTFOUND)', (done)=>{
                ajax.text.get(undefined, 'http://missinghost:10000', 'text', {}, {}, (err, session, result)=>{
                    assert(err);
                    assert.equal(err, 'Error: getaddrinfo ENOTFOUND missinghost');
                    assert(!session);
                    assert(!result);
                    done();
                });
            ...
            it('Make get to missing service(ECONNREFUSED)', (done)=>{
                ajax.text.get(undefined, 'http://localhost:12345', 'text', {}, {}, (err, session, result)=>{
                    assert(err);
                    assert.equal(err, 'Error: connect ECONNREFUSED 127.0.0.1:12345');
                    assert(!session);
                    assert(!result);
                    done();
                });
            ...
            it('Make get and handling empty result', (done)=>{
                ajax.text.get(undefined, 'http://localhost:10000', 'textEmpty', {}, {}, (err, session, result)=>{
                    assert(!err);
                    assert(!session);
                    assert(!result);
                    done();
        ...
        describe('ajax.text.post', ()=>{
            it('Make post to missing host(ENOTFOUND)', (done)=>{
                const data = {
                    value:'PostValue'
                };
                ajax.text.post(undefined, 'http://missinghost:10000', 'text', {}, data, (err, session, result)=>{
                    assert(err);
                    assert.equal(err, 'Error: getaddrinfo ENOTFOUND missinghost');
                    assert(!session);
                    assert(!result);
            ...
            it('Make post to missing service(ECONNREFUSED)', (done)=>{
                const data = {
                    value:'PostValue'
                };
                ajax.text.post(undefined, 'http://localhost:12345', 'text', {}, data, (err, session, result)=>{
                    assert(err);
                    assert.equal(err, 'Error: connect ECONNREFUSED 127.0.0.1:12345');
                    assert(!session);
                    assert(!result);
            ...
            it('Make post and handling empty result', (done)=>{
                const data = {
                    value:'PostValue'
                };
                ajax.text.post(undefined, 'http://localhost:10000', 'textEmpty', {}, data, (err, session, result)=>{
                    assert(!err);
                    assert(!session);
                    assert(!result);
                    done();
        ...
        describe('ajax.text.delete', ()=>{
            it('Make delete to missing host(ENOTFOUND)', (done)=>{
                ajax.text.delete(undefined, 'http://missinghost:10000', 'text', {}, {}, (err, session, result)=>{
                    assert(err);
                    assert.equal(err, 'Error: getaddrinfo ENOTFOUND missinghost');
                    assert(!session);
                    assert(!result);
            ...
            it('Make delete to missing service(ECONNREFUSED)', (done)=>{
                ajax.text.delete(undefined, 'http://localhost:12345', 'text', {}, {}, (err, session, result)=>{
                    assert(err);
                    assert.equal(err, 'Error: connect ECONNREFUSED 127.0.0.1:12345');
                    assert(!session);
                    assert(!result);
            ...
            it('Make delete and handling empty result', (done)=>{
                const data = {
                    value:'PostValue'
                };
                ajax.text.delete(undefined, 'http://localhost:10000', 'textEmpty', {}, data, (err, session, result)=>{
                    assert(!err);
                    assert(!session);
                    assert(!result);
                    done();
    ...
    describe('ajax.json', ()=>{
        describe('ajax.json.get', ()=>{
            it('Make get to missing host(ENOTFOUND)', (done)=>{
                ajax.json.get(undefined, 'http://missinghost:10000', 'text', {}, {}, (err, session, result)=>{
                    assert(err);
                    assert.equal(err, 'Error: getaddrinfo ENOTFOUND missinghost');
                    assert(!session);
                    assert(!result);
            ...
            it('Make get to missing service(ECONNREFUSED)', (done)=>{
                ajax.json.get(undefined, 'http://localhost:12345', 'text', {}, {}, (err, session, result)=>{
                    assert(err);
                    assert.equal(err, 'Error: connect ECONNREFUSED 127.0.0.1:12345');
                    assert(!session);
                    assert(!result);
            ...
            it('Make get and handling empty result', (done)=>{
                ajax.json.get(undefined, 'http://localhost:10000', 'jsonEmpty', {}, {}, (err, session, result)=>{
                    assert(!err);
                    assert(!session);
                    assert(!result);
                    done();
        ...
        describe('ajax.json.post', ()=>{
            it('Make post to missing host(ENOTFOUND)', (done)=>{
                ...
                ajax.json.post(undefined, 'http://missinghost:10000', 'text', {}, data, (err, session, result)=>{
                    assert(err);
                    assert.equal(err, 'Error: getaddrinfo ENOTFOUND missinghost');
                    assert(!session);
                    assert(!result);
            ...
            it('Make post to missing service(ECONNREFUSED)', (done)=>{
                ...
                ajax.json.post(undefined, 'http://localhost:12345', 'text', {}, data, (err, session, result)=>{
                    assert(err);
                    assert.equal(err, 'Error: connect ECONNREFUSED 127.0.0.1:12345');
                    assert(!session);
                    assert(!result);
            ...
            it('Make post and handling empty result', (done)=>{
                ...
                ajax.json.post(undefined, 'http://localhost:10000', 'jsonEmpty', {}, data, (err, session, result)=>{
                    assert(!err);
                    assert(!session);
                    assert(!result);
                    done();
        ...
        describe('ajax.json.delete', ()=>{
            it('Make delete to missing host(ENOTFOUND)', (done)=>{
                ajax.json.delete(undefined, 'http://missinghost:10000', 'text', {}, {}, (err, session, result)=>{
                    assert(err);
                    assert.equal(err, 'Error: getaddrinfo ENOTFOUND missinghost');
                    assert(!session);
                    assert(!result);
            ...
            it('Make delete to missing service(ECONNREFUSED)', (done)=>{
                ajax.json.delete(undefined, 'http://localhost:12345', 'text', {}, {}, (err, session, result)=>{
                    assert(err);
                    assert.equal(err, 'Error: connect ECONNREFUSED 127.0.0.1:12345');
                    assert(!session);
                    assert(!result);
            ...
            it('Make delete and handling empty result', (done)=>{
                ...
                ajax.json.delete(undefined, 'http://localhost:10000', 'jsonEmpty', {}, data, (err, session, result)=>{
                    assert(!err);
                    assert(!session);
                    assert(!result);
                    done();
